...
$defaults = [
    ...
    'course2' => '<a href="?p=contract">WEB250</a> - Database Driven Websites: I’m taking this course to learn how to incorporate SQL into website creation. It’s also required for my AAS program.',
    ...
    <!-- Display intro section -->
        ...
        <ol class="introduction">
            ...
            <li><strong>Courses I'm Taking &#38; Why:</strong>
                <ol>
                <li><strong>1. </strong><?= $data['course1'] ?></li>
<li><strong>2. </strong><?= $data['course2'] ?></li>
<li><strong>3. </strong><?= $data['course3'] ?></li>
<li><strong>4. </strong><?= $data['course4'] ?></li>
                </ol>
            </li>
    ...
    <form method="post">
        ...
        <label>Course 2: <input type="text" name="course2" value="<?= htmlspecialchars(strip_tags($data['course2'])) ?>"></label>
